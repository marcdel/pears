defmodule Pears.Accounts.Team do
  ...
  defp validate_required_email(changeset, opts) do
    changeset
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Pears.Repo)
  ...
  """
  def name_changeset(team, attrs, opts \\ []) do
    team
    |> cast(attrs, [:name])
    |> validate_name(opts)
    |> case do
